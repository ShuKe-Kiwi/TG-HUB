...
BACKUP_ERROR_CODES = frozenset(
    {
        ...
        "BACKUP_PIN_AUDIT_WRITE_FAILED",
        "BACKUP_PIN_WRITE_NOT_AUTHORIZED",
        "BACKUP_RETENTION_INVENTORY_UNSAFE",
        "BACKUP_RETENTION_VERIFIED_FLOOR_VIOLATION",
        "BACKUP_RETENTION_PLAN_STALE",
        "BACKUP_RETENTION_APPLY_NOT_AUTHORIZED",
        "BACKUP_RETENTION_NOREPLACE_UNSUPPORTED",
        "BACKUP_RETENTION_CLEANUP_REQUIRED",
        "BACKUP_BUDGET_EXCEEDED_UNRECOVERABLE",
        "BACKUP_AUTHORIZATION_INVALID",
        "BACKUP_AUTHORIZATION_ALREADY_EXISTS",
        "BACKUP_AUTHORIZATION_ALREADY_CONSUMED",
        "BACKUP_AUTHORIZATION_EXPIRED",
        "BACKUP_AUTHORIZATION_NONCE_INVALID",
        "BACKUP_AUTHORIZATION_ROOT_MISMATCH",
        "BACKUP_AUTHORIZATION_PREDECESSOR_INVALID",
        "BACKUP_AUTHORIZATION_LOCK_INVALID",
        "BACKUP_AUTHORIZATION_WRITE_FAILED",
        "BACKUP_AUTHORIZATION_ISSUER_UNAVAILABLE",
        "BACKUP_RETENTION_EXECUTION_IDENTITY_INVALID",
